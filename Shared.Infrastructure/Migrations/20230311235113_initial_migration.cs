    ...
    public partial class initial_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK___Identity_UserLogin", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK___Identity_UserRole", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK___Identity_UserToken", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX___Identity_User_Email_UserName",
                table: "__Identity_User",
            ...
            migrationBuilder.CreateIndex(
                name: "IX___Identity_UserLogin_UserId_LoginProvider",
            ...
            migrationBuilder.CreateIndex(
                name: "IX___Identity_UserRole_UserId_RoleId",
                table: "__Identity_UserRole",
                columns: new[] { "UserId", "RoleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX___Identity_UserToken_UserId_LoginProvider",
                table: "__Identity_UserToken",
                columns: new[] { "UserId", "LoginProvider" },
                unique: true);
        }
