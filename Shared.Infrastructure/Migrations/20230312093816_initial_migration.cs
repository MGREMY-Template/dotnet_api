...
public partial class initial_migration : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK___Identity_RoleClaim", x => x.Id);
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK___Identity_UserClaim", x => x.Id);
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK___Identity_UserLogin", x => new { x.LoginProvider, x.ProviderKey });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK___Identity_UserRole", x => new { x.UserId, x.RoleId });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK___Identity_UserToken", x => new { x.UserId, x.LoginProvider, x.Name });
                _ = table.ForeignKey(
