...
namespace Shared.Application.Services
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        protected GenericService(
            IGenericRepository<T, TKey> unitOfWork,
            IMapper mapper,
        ...
        {
            return Result.Create(await _repository.CountAsync(cancellationToken));
        }
        ...
        {
            return Result.Create(await _repository.GetByKeyAsync(id, cancellationToken))
                .Ensure(x => x is not null,
                    _globalStringLocalizer.GetString(Core.Resources.GlobalConstants.InternalServerError).ToStringArray())
        ...
        {
            return Result.Create(await _repository.ExistsAsync(id, cancellationToken));
        }
    }
}
